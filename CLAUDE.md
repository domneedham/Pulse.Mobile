...
- Follow existing codebase style and structure.
...
- Utilize the custom overrides for lifecycle events (OnViewAppearing, OnViewDisappearing, OnViewNavigatedTo and OnViewNavigatedFrom)
...
- Use the navigation service for all page and modal navigation. Do not rely on the built in tools without justification.
